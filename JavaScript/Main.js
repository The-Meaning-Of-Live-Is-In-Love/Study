...
function Switching_Color_Complementary(id)
{
    ...
    if (Color_Complementary_Type == 1)
    {
        ...
        document.documentElement.style.setProperty('--Color_Complementary_1', '127, 215, 245');
        localStorage.setItem('--Color_Complementary_1', '127, 215, 245');
        document.documentElement.style.setProperty('--Color_Complementary_2', '192, 235, 250');
        localStorage.setItem('--Color_Complementary_2', '192, 235, 250');
    }
    if (Color_Complementary_Type == 2)
    {
        ...
        document.documentElement.style.setProperty('--Color_Complementary_1', '255, 203, 219');
        localStorage.setItem('--Color_Complementary_1', '255, 203, 219');
        document.documentElement.style.setProperty('--Color_Complementary_2', '250, 218, 221');
        localStorage.setItem('--Color_Complementary_2', '250, 218, 221');
    }
}
